...
export const SAFETY_SECTION_TEMPLATES: SafetySectionTemplate[] = [
	...
	},
	{
		...
		description:
			'Залиш у списку лише безпечні дії біля річок, озер і водойм. Небезпечні картки перетягни за межі секції.',
		cards: [
			{
				id: 'water-1',
				emoji: '🦺',
				text: 'Одягати рятувальний жилет під час катання на човні.',
				isSafe: true,
			},
			{
				id: 'water-2',
				emoji: '🌊',
				text: 'Пірнати у незнайомому місці, не перевіривши глибину.',
				isSafe: false,
			},
			{
				id: 'water-3',
				emoji: '👨‍👩‍👧',
				text: 'Купатися тільки поруч із дорослими.',
				isSafe: true,
			},
			{
				id: 'water-4',
				emoji: '🏃',
				text: 'Бігати по слизькому пірсу або каменях біля води.',
				isSafe: false,
			},
			{
				id: 'water-5',
				emoji: '📍',
				text: 'Обирати для купання лише дозволені та облаштовані місця.',
				isSafe: true,
			},
			{
				id: 'water-6',
				emoji: '🧊',
				text: 'Виходити на тонкий лід узимку заради гри.',
				isSafe: false,
			},
			{
				id: 'water-7',
				emoji: '📣',
				text: 'Кликати дорослих або рятувальників, якщо хтось у небезпеці.',
				isSafe: true,
			},
			{
				id: 'water-8',
				emoji: '🚫',
				text: 'Запливати далеко від берега, коли втомився.',
				isSafe: false,
			},
			{
				id: 'water-9',
				emoji: '🏖️',
				text: 'Перед купанням перевіряти погоду та стан води.',
				isSafe: true,
			},
			{
				id: 'water-10',
				emoji: '📱',
				text: 'Підходити надто близько до води, дивлячись у телефон.',
				isSafe: false,
			},
		],
	},
